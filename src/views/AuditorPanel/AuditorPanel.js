...
class AuditorPanel extends Component {
  ...
  skipVerifierResponse() {
    ...
    fetch(constants.local_base_url + "/audit/v1/skip", {
      method: "POST", headers: {
  ...
  submitVerifierResponse() {
    if (this.checkBeforeSubmitting()) {
      ...
      fetch(constants.local_base_url + "/audit/v1/submit", {
        method: "POST", headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json',
          'Cache': 'no-cache',
    ...
    if (this.state.loaded == true && "customer_name" in this.state.customer_info) {
                  ...
                  if (item.is_verification_needed == true && item.data_type == "file_upload") {
                    ...
                    return (
                      <div className={answer_div_class} >
                        ...
                        <div className="col-sm-12 col-lg-6 col-md-6" style={{ maxWidth: 400 + "px", maxHeight: 400 + "px" }} >
      ...
      return (
        <>
          ...
          <div style={{ "textAlign": "center", "margin": "auto", "paddingTop": 40 + "px", "color": "#ff6501" }}>
            <div>

              <BasicFilter onComplete={this.getAnswersToVerify}></BasicFilter>
            </div>
